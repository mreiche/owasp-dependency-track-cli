...
from owasp_dt_cli import config, models
from owasp_dt_cli.analyze import handle_analyze
from owasp_dt_cli.metrics import handle_prometheus_metrics
from owasp_dt_cli.project import (
    handle_project_activate,
    handle_project_cleanup,
    handle_project_deactivate,
    handle_project_property_remove,
